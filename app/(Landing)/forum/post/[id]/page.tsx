  ...
  return (
    <div className="min-h-screen bg-gray-50 w-full overflow-x-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="mb-4">
          <span className="inline-block bg-blue-100 text-blue-800 rounded-full px-4 py-1 text-sm font-medium break-words max-w-full">
            {post.category.name}
          </span>
        </div>

        <div className="bg-white overflow-hidden rounded-none sm:rounded-xl shadow-none sm:shadow-lg w-full">
          ...
          <div className="p-4 sm:p-6 w-full overflow-hidden">
            {post.tags.length > 0 && (
              <div className="flex flex-wrap gap-2 mb-6">
                {post.tags.map((tag, index) => (
                  <span
                    key={index}
                    className="text-sm bg-gray-100 text-gray-700 px-3 py-1 rounded-full hover:bg-gray-200 cursor-pointer transition-colors break-words max-w-full"
                  >
                    #{tag}
                  </span>
                ))}
            ...
            <div className="mb-6 w-full overflow-hidden">
              <p className="text-gray-700 text-lg leading-relaxed whitespace-pre-wrap break-words overflow-wrap-anywhere">
                {post.content}
              </p>
            </div>
